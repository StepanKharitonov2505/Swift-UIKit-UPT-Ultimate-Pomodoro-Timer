...
extension UICollectionView {
    ...
    func registerCellFromNib<CellType>(ofType: CellType.Type)
        ...
        register(
            nib,
            forCellWithReuseIdentifier: classString
        )
    }
     ...
     */
    func dequeueCellOf<CellType>(
        type: CellType.Type,
        for indexPath: IndexPath
    ) -> CellType where CellType: UICollectionViewCell {
    ...
    // MARK: - Supplementary
    func registerSupplementaryFromNib<CellType>(
        ofType: CellType.Type,
        kind: String
    ...
    func dequeueSupplementaryOf<CellType>(
        type: CellType.Type,
        for indexPath: IndexPath,
        kind: String
    ) -> CellType where CellType: UICollectionReusableView {
            let cellId = String(describing: type.self)
